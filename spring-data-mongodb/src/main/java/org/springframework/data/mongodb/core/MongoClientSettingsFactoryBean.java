...
public class MongoClientSettingsFactoryBean extends AbstractFactoryBean<MongoClientSettings> {
	...
	/**
	 * @param clusterMaxWaitQueueSize
	 * @see com.mongodb.connection.ClusterSettings.Builder#maxWaitQueueSize(int)
	 */
	...
	/**
	 * @param poolMaxWaitQueueSize
	 * @see com.mongodb.connection.ConnectionPoolSettings.Builder#maxWaitQueueSize(int)
	 */
